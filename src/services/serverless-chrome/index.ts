/**
 * This source was taken from github.com/adieuadieu/serverless-chrome package.
 *
 * I bundled a modified version of @serverless-chrome/lambda package
 * because the original package couldn't satisfy our stability requirements.
 *
 * It is Copyright Marco Lüthy, licensed under MIT License
 * Copyright (c) 2017-2018 Marco Lüthy
 * https://github.com/adieuadieu/serverless-chrome/blob/master/LICENSE
 */
...
}: LaunchOption = {}): Promise<LaunchedChrome> {
